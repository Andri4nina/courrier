...
@section('content')
                    ...
                    <div class="w-1/3">
                        ...
                        <div
                            ...
                            <div class="w-2/3 flex justify-end items-center gap-2">
                                ...
                                <div class="relative group">
                                    <form
                                        action="{{ route('send-mail-notification-rappel', ['idFact' => $courriers->fact_id, 'status' => $courriers->status]) }}">
    ...
    <script>
        function colorizeRegions() {
            var expRegion =
            "{{ strtoupper(str_replace([' ', "'", '-'], ['_', '_', '_'], $courriers->exp_post->region)) }}";
            var destRegion =
                "{{ strtoupper(str_replace([' ', "'", '-'], ['_', '_', '_'], $courriers->dest_post->region)) }}";

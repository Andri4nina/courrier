            ...
            <div class="bounceslideInFromRight p-5 min-w-4xl crud-card">
                <div class="top-card">
                    <div class=" text-white font-bold items-center flex gap-2">
                        ...
                        <h4 class="text-white my-5">Tous les Colis et Courriers expedier par notre postes</h4>
                    </div>

                    <hr>
                    <div class="  w-full">
                        <form action="{{ route('courrier.expediteur') }}">
                            ...
                            <div class="text-white grid grid-cols-3 gap-2 w-11/12 mx-auto">
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 gap-4">
                                        <img src="{{ asset('images/Postman.png') }}" alt=""
                                        ...
                                        <div
                                            ...
                                            <div class="w-2/3">
                                                <input type="text"
                                                    ...
                                                    name='nom_exp' value={{ $courriers->exp->nom }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <div class="w-2/3">
                                                <input type="text"
                                                    class=" w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name='prenom_exp' value={{ $courriers->exp->prenom }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="text"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name="adresse_exp" value={{ $courriers->exp->adresse }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="email"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name="email_exp" value={{ $courriers->exp->email }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="tel"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name="tel_exp" value={{ $courriers->exp->tel }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                    ...
                                    <div class="">
                                        <div
                                            ...
                                            <div class="w-2/3">
                                                <input type="text"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white uppercase"
                                                    name='nom_exp' value={{ $courriers->dest->nom }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 capitalize flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="text"
                                                    class=" w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name='prenom_exp' value={{ $courriers->dest->prenom }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="text"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name="adresse_exp" value={{ $courriers->dest->adresse }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="email"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name="email_exp" value={{ $courriers->dest->email }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">
                                            ...
                                            <div class="w-2/3">
                                                <input type="tel"
                                                    class="w-full text-left bg-transparent pr-3 outline-none text-white"
                                                    name="tel_exp" value={{ $courriers->dest->tel }} @disabled(true)>
                                            </div>
                                        </div>
                                        <div
                                            class="inputfield w-full px-4 relative py-1 mb-5 border-b-2 flex justify-between items-center gap-2">

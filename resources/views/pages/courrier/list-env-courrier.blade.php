                                    ...
                                    @foreach ($courriers as $courriers)
                                        <tr class="hover:bg-slate-800 hover:text-slate-50   border-b">
                                            ...
                                            <td class="px-4 py-2 ">
                                                <div class="flex justify-center items-center gap-2">
                                                    <div class="relative group">
                                                        <form action="{{ route('courrier.edit', $courriers->id) }}">
                                                            <button
                                                                class="w-8 h-8 border text-blue-500 border-blue-500  hover:bg-blue-500 hover:shadow-blue-700 hover:shadow-lg hover:text-white  font-bold ">
